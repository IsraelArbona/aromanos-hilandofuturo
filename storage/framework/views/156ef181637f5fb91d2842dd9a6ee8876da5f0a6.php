<?php $__env->startSection('pageheader'); ?>
    <nav class="navbar navbar-expand-md navbar-light">
        ...
        <h4 class="c-grey-900">
        Factura Compras <small>(Lista)</small>
        </h4>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('facturacions.inv_facturacompras.create')): ?>
                        <a href="<?php echo e(route('facturacions.inv_facturacompras.create')); ?>" class="btn nav-link bbou-pink-400 rounded-pill" rel="tab">
...
<script defer type="text/javascript">
    ...
    var urls = "<?php echo e(route('facturacions.inv_facturacompras.dtCargarInvfacturacompras',[$ddes,$dhas])); ?>";
    var urlstot = "<?php echo e(route('facturacions.inv_facturacompras.dtCargarInvfacturacomprasTot',[$ddes,$dhas])); ?>";
    var urlsexc = "<?php echo e(route('facturacions.inv_facturacompras.exceldet',[$ddes,$dhas])); ?>";
    ...
    function processFac(facin, facfi, facinlimit, intervalofa) {
      if (facin < facfi) {
          ...
          console.log(facinlimit.toString() + ' ' + intervalofa.toString());

          urls = "<?php echo e(route('facturacions.inv_facturacompras.facturacompraPdf', ['f_inilim' => ':inilim','f_inter' => ':inter','f_des' => ':des','f_has' => ':has'])); ?>";
    ...
    $('.aggbuscar').click(function(e){
        ...
        var urls = "<?php echo e(route('facturacions.inv_facturacompras.dtCargarInvfacturacompras', ['ddes' => ':pdes','dhas' => ':phas'])); ?>";
        var urlstot = "<?php echo e(route('facturacions.inv_facturacompras.dtCargarInvfacturacomprasTot', ['ddes' => ':pdes','dhas' => ':phas'])); ?>";
        var urlpexc = "<?php echo e(route('facturacions.inv_facturacompras.exceldet', ['ddes' => ':pdes','dhas' => ':phas'])); ?>";

        urls = urls.replace(':pdes', $("input[name='desde']").val());
        urls = urls.replace(':phas', $("input[name='hasta']").val());
...
<?php $__env->stopSection(); ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/aromanos-guane/resources/views/facturacions/inv_facturacompras/index.blade.php ENDPATH**/ ?>