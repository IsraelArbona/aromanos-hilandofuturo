    <div class="row mB-4">
        <div class="col-sm-12">
            <div class="bgc-white p-4 bd">
                ...
                <div class="form-row">
                    <?php if(isset($inv_facturacompra->id) > 0): ?>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-6">
                            <?php echo Form::mySelect('persona_id', '* (Doc.) Proveedor', $personas, null, ['class' => 'form-control cbpersona', 'data-url' => route('home.sBuscarPersonas'),'data-width' =>'100%','required']); ?>

                        </div>

                        <div class="col-md-2">
                            <?php if(isset($inv_facturacompra->estadot) > 0): ?>
                                <?php if(($inv_facturacompra->estadot == 0) and (Auth::user()->id > 1)): ?>
            ...
            <div class="bgc-white p-4 bd">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3 bbou-pink-400">
                        <?php echo Form::myInput('number', 'base', '* Costo', ['class' => 'form-control basepr','maxlength' => '18', 'onchange' => 'openproducto();'],0); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <?php if(isset($inv_facturacompra->total) > 0): ?>
                                    <button type="submit" class="btn text-white bgc-pink-400 sf_editar_facturaVC" disabled
                                    data-remote="<?php echo e(route('facturacions.inv_facturacompras.update', $inv_facturacompra->id)); ?>">+</button>
                                <?php else: ?>
                                    <button type="submit" class="btn text-white bgc-pink-400 sf_guardar_facturaVC"
                                    data-remote="<?php echo e(route('facturacions.inv_facturacompras.store')); ?>">+</button>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row mB-4">
        <div class="col-sm-12">
            <div class="bgc-white p-4 bd">
                <div class="form-row">
                    <div class="col-md-3">
                        <?php if(isset($inv_facturacompra->subtotal) > 0): ?>
                    ...
                    <div class="col-md-3">
                        <?php if(isset($inv_facturacompra->iva) > 0): ?>
                    ...
                    <div class="col-md-3">
                        <?php if(isset($inv_facturacompra->descuento) > 0): ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/aromanos-guane/resources/views/facturacions/inv_facturacompras/partials/forme.blade.php ENDPATH**/ ?>