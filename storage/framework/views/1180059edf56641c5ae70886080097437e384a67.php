<div class="row mB-40">
	<div class="col-sm-12">
		<div class="bgc-white p-20 bd">
            ...
            <?php echo Form::mySelect('inv_categoria_id', '* Categoria', $inv_categorias, null, ['class' => 'form-control','data-width' =>'100%','required']); ?>


            <?php if(isset($inv_subcategorias->estadot) > 0): ?>
                <?php if(($inv_subcategorias->estadot == 0) and (Auth::user()->id > 1)): ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/aromanos-guane/resources/views/inventarios/inv_subcategorias/partials/forme.blade.php ENDPATH**/ ?>