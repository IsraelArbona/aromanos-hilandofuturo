<li class="nav-item dropdown">
      ...
      <ul class="dropdown-menu">
        ...
        @can('inventarios.inv_categorias.index')
        <li class="nav-item dropdown">
          <a href="{{ route('inventarios.inv_categorias.index') }}"  rel="tab">
            <span class="icon-holder">
        ...
        @can('inventarios.inv_subcategorias.index')
        <li class="nav-item dropdown">
          <a href="{{ route('inventarios.inv_subcategorias.index') }}"  rel="tab">
            <span class="icon-holder">
        ...
        @can('inventarios.inv_unidades.index')
        <li class="nav-item dropdown">
          <a href="{{ route('inventarios.inv_unidades.index') }}"  rel="tab">
            <span class="icon-holder">
        ...
        @can('inventarios.inv_bodegas.index')
        <li class="nav-item dropdown">
          <a href="{{ route('inventarios.inv_bodegas.index') }}"  rel="tab">
            <span class="icon-holder">
        ...
        @can('inventarios.inv_productos.index')
        <li class="nav-item dropdown">
          <a href="{{ route('inventarios.inv_productos.index') }}"  rel="tab">
            <span class="icon-holder">
